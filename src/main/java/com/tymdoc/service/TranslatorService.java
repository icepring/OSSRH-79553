...
import com.tymdoc.service.translator.impl.*;
import com.tymdoc.util.CollectionUtil;
...
public class TranslatorService {
    ...
    private final Map<String, Translator> translatorMap = ImmutableMap.<String, Translator>builder()
        ...
        .put(Consts.GOOGLE_TRANSLATOR, new GoogleTranslator())
        .build();
    ...
    private String getFromOthers(String word) {
        ...
        String res = translator.en2Ja(word);
        if (res != null) {
            res = res.replace("的", "");
        }
        return res;
